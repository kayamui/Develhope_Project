...
SELECT p.ProductID , s.CompanyName ,  p.ProductName , COUNT(od.Quantity) AS Quantity , c.CategoryName  FROM Categories c
...
SELECT P.ProductID , p.ProductName, od.Quantity  ,o.ShipCity  FROM Orders o 
